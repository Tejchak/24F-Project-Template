...
@student.route('/students/<int:student_id>/apply', methods=['POST'])
...
@student.route('/students/<int:student_id>/applications', methods=['GET'])
...
@student.route('/students/<int:student_id>/recommendations', methods=['GET'])
...
@student.route('/students/<int:student_id>/applications/<int:application_id>', methods=['DELETE'])
